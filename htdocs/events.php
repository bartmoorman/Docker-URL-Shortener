...
$shortener = new Shortener(true, true, true, false);
?>
<!DOCTYPE html>
<html lang='en'>
  <head>
...
foreach ($shortener->getEvents($currentPage) as $event) {
...
<?php
$pages = ceil($shortener->getObjectCount('events') / $shortener->pageLimit);

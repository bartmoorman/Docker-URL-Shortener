...
$shortener = new Shortener(true, false, false, true);
?>
<!DOCTYPE html>
<html lang='en'>
  <head>
    <title><?php echo $shortener->appName ?> - Login</title>
    <meta charset='utf-8'>
        ...
        <div class='modal-content'>
          <form>
            <div class='modal-header py-2'>
              <h3 class='modal-title w-100 text-center'><?php echo $shortener->appName ?></h3>
            </div>
